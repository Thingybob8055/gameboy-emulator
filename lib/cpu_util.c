...
u16 reverse(u16 n) {
    return ((n & 0xFF00) >> 8) | ((n & 0x00FF) << 8); //To get full 16 bit value for registers AF, BC, DE, HL etc
}
...
//8bit version of read register, these are specifically for 8-bit and bitwise functions
